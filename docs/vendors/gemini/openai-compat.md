<!-- source: https://ai.google.dev/gemini-api/docs/openai
     fetched: 2026-05-02T12:55:55.776Z -->
...
- [Generate a video](https://ai.google.dev/gemini-api/docs/openai#generate-video)
  - [Check video status](https://ai.google.dev/gemini-api/docs/openai#check-video-status)
...
- [Flex and Priority inference](https://ai.google.dev/gemini-api/docs/openai#inference)
- [Enable Gemini features with extra\_body](https://ai.google.dev/gemini-api/docs/openai#extra-body)
  - [Example using extra\_body](https://ai.google.dev/gemini-api/docs/openai#extra-body-example)
