...
Fetched: 2026-05-02T12:57:02.070Z
-->
...
New\\
\\
A new class of intelligence for coding and professional work.](https://developers.openai.com/api/docs/models/gpt-5.5)
...
[GPT-5.4\\
\\
A more affordable model for coding and professional work.](https://developers.openai.com/api/docs/models/gpt-5.4)
...
[![gpt-image-2](https://developers.openai.com/images/api/models/icons/gpt-image-2.png)\\
\\
GPT Image 2\\
\\
State-of-the-art image generation model](https://developers.openai.com/api/docs/models/gpt-image-2)
